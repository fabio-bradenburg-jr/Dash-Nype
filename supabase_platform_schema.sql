-- Nype SaaS platform schema for Supabase SQL Editor
-- Project ref detected from the current frontend config: rsaaeueancpdytjrvquk
-- Run this file in Supabase SQL Editor before pointing Prisma/NestJS to the database.
