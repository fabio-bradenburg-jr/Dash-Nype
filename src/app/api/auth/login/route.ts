...
import { loginWithLocalDatabase } from '@/lib/server/platform-auth-fallback'
...
export async function POST(request: Request) {
  ...
  try {
    ...
    try {
      ...
      return NextResponse.json(
        { error: fallbackError instanceof Error ? fallbackError.message : 'Não foi possível entrar.' },
        { status: 500 }
      )
    }
  }
