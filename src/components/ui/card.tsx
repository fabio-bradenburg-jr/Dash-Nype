...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        'rounded-[30px] border border-white/80 bg-[var(--saas-panel-bg)] shadow-[0_20px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl transition-transform duration-300 hover:-translate-y-0.5',
        className
      )}
      {...props}
    />
