  ...
  return (
    <div className="ios-notes-shell">
          ...
          <>
            ...
            <div className="ios-notes-editor-meta">
              ...
              {selectedNote && activeClientId === ALL_CLIENTS && (() => {
                ...
                return cn ? <span className="ios-notes-warning" style={{ color: 'var(--button-primary,#e53935)', fontStyle: 'normal', fontWeight: 600 }}>{cn}</span> : null
              })()}
            </div>
      ...
      <style jsx>{`
        ...
        .ios-save-btn { color: var(--button-primary, #e53935); }
        .ios-save-btn:hover { background: rgba(var(--accent-rgb, 229, 57, 53), 0.12); }
        ...
        .ios-save-status.saved { color: var(--button-primary, #e53935); }
        ...
        :global(.ios-notes-editor ul.checklist li .check-circle) {
          ...
          min-width: 16px;
          border-radius: 50%;
          border: 2px solid var(--button-primary, #e53935);
          display: inline-flex;
          align-items: center;
          justify-content: center;
          cursor: pointer;
        ...
        .ios-notes-new-btn-cta:hover { background: rgba(var(--accent-rgb, 229, 57, 53), 0.08); }
        ...
        :global(.ios-notes-list-item.selected) { background: rgba(var(--accent-rgb, 229, 57, 53), 0.12); }
        ...
        :global(.ios-note-subnote-btn) { color: var(--button-primary, #e53935); font-size: 11px; font-weight: bold; }
        :global(.ios-note-subnote-btn:hover) { background: rgba(var(--accent-rgb, 229, 57, 53), 0.12); }
        ...
        :global(.dashboard-light-mode .ios-notes-list-item.selected) { background: rgba(var(--accent-rgb, 229, 57, 53), 0.12); }
        ...
        :global(.dashboard-light-mode .ios-note-client-badge) { background: rgba(var(--accent-rgb, 229, 57, 53), 0.15); }
